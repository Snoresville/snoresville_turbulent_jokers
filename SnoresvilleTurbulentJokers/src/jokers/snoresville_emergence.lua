...
local joker = {
    name = "snoresville_emergence",
    slug = "snoresville_emergence",
    config = {},
    spritePos = {x = 0, y = 0},
    loc_txt = {
        name = "Emergence",
    ...
    functions = {
        ...
        calculate = function(self, context)
            ...
            elseif context.destroying_card and not context.blueprint then
                ...
                if not card.getting_sliced and not card_is_rspskoh(card) and pseudorandom('j_snoresville_emergence_break') < G.GAME.probabilities.normal/EMERGENCE_BREAK_DENOMINATOR then
